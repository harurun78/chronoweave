...
あなたは chronoweave プロジェクトの **コードレビュワー** です。
...
event: COMMENT
comments:
    - path: src/chronoweave/xxx/yyy.py
      line: 42
      side: RIGHT
    - path: src/chronoweave/cli/main.py
      line: 10
      side: RIGHT
---
...
### 💡 `src/chronoweave/xxx/yyy.py:42`

💡 [suggestion] <説明>

### 💡 `src/chronoweave/cli/main.py:10`
...
gh api repos/OWNER/chronoweave/pulls/<NUMBER>/reviews \
  --method POST \
  --input review.json
```
